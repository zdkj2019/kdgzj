...
public class InformationReceivinglist extends FrameActivity {
			...
			public void onItemClick(AdapterView<?> parent, View view, int arg2,
				...
				if (arg2 >= 0) {
					...
					Intent intent = new Intent(
							InformationReceivinglist.this,
							InformationReceivingActivity.class);
		...
		if ("query".equals(s) && !backboolean) {
			try {//_PAD_SHGL_PGDCZ
				...
				JSONObject jsonObject = callWebserviceImp.getWebServerInfo(
						"_PAD_JDXY_CX1", "2000-01-01*3000-01-01*"
